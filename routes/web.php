...
Route::group(["prefix"=>"/admin/order/","middleware"=>["adminAuthen"]],function() {
    Route::get("/search",[oderController::class,"searchOrder"]);
    Route::get('/list-order',[oderController::class,"showOrder"]);
    Route::delete("/{id}",[oderController::class,"deleteOrder"]);
});

// user account management admin
Route::group(["prefix"=>"/admin/user","middleware"=>["adminAuthen"]],function() {
