            ...
            <div class="col-lg-6">
                <div class="nk-product-cat-2">
                    ...
                    <div class="nk-product-cont">
                        ...
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-rating" data-rating="{{$product->rate}}"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fas fa-star-half"></i> <i class="far fa-star"></i> <i class="far fa-star"></i></div>
                        <div class="nk-gap-1"></div>
                        {{$product->content}}
                        <div class="nk-gap-2"></div>
