...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- font-awesome icons -->
    <link rel="stylesheet" href="{{asset('public/admin_assets/css/font.css')}}" type="text/css" />
...
<body>
        ...
        <header class="header fixed-top clearfix">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('public/admin_assets/images/3.png')}}"></span>
                                    <span class="subject">
            ...
            <div class="top-nav clearfix">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{asset('public/admin_assets/images/2.png')}}">
                            <span class="username">
                                <?php
    ...
    <script src="{{asset('public/admin_assets/js/jquery.dcjqaccordion.2.7.js')}}"></script>
    ...
    <!-- calendar -->
    <script type="text/javascript" src="{{asset('public/admin_assets/js/monthly.js')}}"></script>
